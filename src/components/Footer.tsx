  ...
  return (
    <>
      <footer className="bg-y relative">
        ...
        <section className="flex flex-col items-center justify-center pt-32 gap-y-4">
          ...
          <p className="flex py-16 gap-4">
            <span className="bg-r px-2 py-2 rounded-full w-14 h-14 text-2xl flex items-center justify-center border border-e-4 border-y-1 border-l-1 border-black text-white">
              <FaTwitter />
            </span>
            <span className="bg-r px-2 py-2 rounded-full w-14 h-14 text-2xl flex items-center justify-center border border-e-4 border-y-1 border-l-1 border-black text-white">
              <FaTelegramPlane />
          ...
          <p className="pangolin-regular text-xl lg:text-2xl">© Kong 2024 - All Rights Reserved</p>
        </section>
      </footer>
    </>
  );
